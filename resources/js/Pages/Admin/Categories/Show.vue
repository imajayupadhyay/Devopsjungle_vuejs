          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">Category details and blog posts</p>
              </div>
            </div>
              ...
              <div class="p-6">
                ...
                <div class="text-center mb-6">
                  ...
                  >
                    <i
                      ...
                      :style="`color: ${category.color}; font-size: 2rem`"
                    ></i>
                  </div>
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <span class="text-sm text-gray-600 dark:text-gray-400">{{ category.sort_order }}</span>
                  </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600">
                  ...
                  <div v-if="category.meta_title" class="mb-3">
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Meta Title</label>
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ category.meta_title }}</p>
                  </div>

                  <div v-if="category.meta_description" class="mb-3">
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Meta Description</label>
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ category.meta_description }}</p>
                  </div>

                  <div v-if="category.meta_keywords">
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Meta Keywords</label>
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ category.meta_keywords }}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
              <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                <div class="flex items-center justify-between">
                  ...
                  <Link
                    :href="route('admin.blogs.create', { category: category.id })"
              ...
              <div class="p-6">
                <div v-if="category.blogs && category.blogs.length > 0" class="space-y-4">
                  <div
                ...
                <div v-else class="text-center py-12">
                  ...
                  <p class="text-gray-600 dark:text-gray-400 mb-4">
                    This category doesn't have any blog posts yet.
                  </p>
                  <Link
                    :href="route('admin.blogs.create', { category: category.id })"
                ...
                <!-- View All Posts Link -->
                <div v-if="category.blogs && category.blogs.length > 0" class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-600 text-center">
                  <Link
                    :href="route('admin.blogs.index', { category: category.id })"
...
const toggleStatus = () => {
  router.patch(route('admin.categories.toggle-status', props.category.id), {}, {
    preserveScroll: true
  })
}
